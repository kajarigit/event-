...
const { User, Stall } = require('./backend/src/models/index.sequelize');
const { generatePassword } = require('./backend/src/utils/helpers');
const { sendStallOwnerCredentials } = require('./backend/src/services/emailService');
